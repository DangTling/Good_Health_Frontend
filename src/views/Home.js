...
import { fetchAllMedicine } from "../service/medicineService";
          ...
          <div className="col2">
            <div className="row1">
              <img
                ...
                alt="banner"
                style={{ borderRadius: "20px", marginBottom: "1%" }}
              />
            </div>
            <div className="row2">
              <div className="btn">
        ...
        <div className="list">
          ...
          {error ? (
            <>
              <svg style={{ display: "none" }}>
                ...
                >
                  <g transform="translate(0 -270.542)">
                    ...
                    <g
                      fill="#282b24"
                      transform="matrix(1 0 0 1.0177 .283 -5.653)"
                    >
                      <ellipse
                        cx="10.205"
                        cy="278.668"
              ...
              <div class="container">
                <h1>403</h1>
                <p>Hãy đăng ký để xem thông tin thuốc và bệnh</p>
                <svg class="keyhole">
                  <use href="#keyhole" />
                </svg>
              </div>
              ...
              {listMedicine.map((item, index) => {
                return (
                  ...
                  >
                    ...
                    <h4>{item.name}</h4>
                    {item.price ? (
                      <span>{item.price} VNĐ / Vỉ </span>
                    ) : (
                      <span>Thuốc mua theo chỉ định bác sĩ</span>
                    )}
                    <div>{item.type}</div>
                  </div>
                );
